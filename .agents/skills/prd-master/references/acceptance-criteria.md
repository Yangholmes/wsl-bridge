...
- [Overview](#overview)
- [Why Acceptance Criteria Matter](#why-acceptance-criteria-matter)
- [Given-When-Then Format (BDD)](#given-when-then-format-bdd)
- [The "Three Amigos" Practice](#the-three-amigos-practice)
- [Best Practices](#best-practices)
- [Alternative Formats](#alternative-formats)
- [BDD Tools & Automation](#bdd-tools--automation)
- [When NOT to Use Given-When-Then](#when-not-to-use-given-when-then)
- [Templates](#templates)
- [Checklist](#checklist)
...
- [references/user-stories.md](user-stories.md) — User story writing guide
